...
extension ScreenSharingService {
    private func fetchNewFrame() {
        ...
        readingQueue.addOperation { [weak self] in
            ...
            let surfaceProps = self.persistance.object(forKey: BroadcastExtensionConstants.ioSurfacePropertiesDefaultsKey) as! CFDictionary
            ...
            let orientation = CGImagePropertyOrientation(rawValue: (self.persistance.object(forKey: BroadcastExtensionConstants.orientationDefaultsKey) as! NSNumber).uint32Value)!
